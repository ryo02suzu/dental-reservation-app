-- ============================================================
-- Supabase セットアップSQL（dental-reservation-app）
-- Supabaseダッシュボード → SQL Editor に貼り付けて Run してください。
-- 自動生成: drizzle-kit generate（shared/schema.ts より）
-- ============================================================
...
-- ============================================================
-- セッション保存用テーブル（connect-pg-simple）
-- アプリは createTableIfMissing:true で自動作成も可能だが、
-- 接続先がDBポートを開けていない環境向けに手動作成分も用意。
-- ============================================================
